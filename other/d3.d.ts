...
declare module D3 {
    ...
    export interface Selection extends Selectors, any[] {
        attr: {
            (name: string): string;
    ...
    export module Layout {
        ...
        export interface Bin extends any[] {
            x: number;
            dx: number;
            y: number;
        }
    ...
    export module Geo {
        export interface Geo {
            ...
            */
            bounds(feature: any): Array<number[]>;
            /**
            ...
            */
            projectionMutator(rawFactory: (lambda: number, phi: number) => number[]): Projection;
            /**
        ...
        export interface Rotation extends any[] {
    ...
    export module Geom {
        ...
        export interface Vertice extends number[] {
            /**
